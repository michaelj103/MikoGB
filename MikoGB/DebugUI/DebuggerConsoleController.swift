...
class DebuggerConsoleController {
    ...
    init() {        
        ...
        defaultAttrs[NSAttributedString.Key.font] = NSFont(name: "Andale Mono", size: 12.0)
        ...
        let descriptor = NSFontDescriptor(name: "Andale Mono", size: 12.0).withSymbolicTraits([.bold])
