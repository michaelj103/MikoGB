//
//  LoadInstructions8.hpp
//  MikoGB
//
//  Created on 5/5/20.
//

#ifndef LoadInstructions8_hpp
#define LoadInstructions8_hpp
...
int loadRegisterFromPtrHL(const uint8_t *, MikoGB::CPUCore &);
...
int loadRegisterFromImmediate8(const uint8_t *, MikoGB::CPUCore &);
...
int loadPtrHLFromRegister(const uint8_t *, MikoGB::CPUCore &);
