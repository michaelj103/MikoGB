...
/// RES b, r     (Extended opcode 0xCB)
/// Resets the specified bit of register r. Bits are [ 1, 0, b2, b1, b0, r2, r1, r0 ]
/// Able to specify 7 registers A(111), B(000), C(001), D(010), E(011), H(100), L(101).
/// 8th code (110) operates on byte at address (HL), see instruction below
int bitResetRegister(const uint8_t *, MikoGB::CPUCore &);

/// RES b, (HL)     (Extended opcode 0xCB)
/// Resets the specified bit of byte at (HL). Bits are [ 1, 0, b2, b1, b0, 1, 1, 0 ]
int bitResetPtrHL(const uint8_t *, MikoGB::CPUCore &);
